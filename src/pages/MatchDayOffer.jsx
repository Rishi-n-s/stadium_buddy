...
export default function MatchDayOffer({ onBack }) {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center">
      ...
      {/* Header */}
      <div className="w-full glass-overlay border-b border-outline-variant/30 p-4 flex items-center justify-between sticky top-0 z-50">
        <Button 
          onClick={onBack} 
          className="material-symbols-outlined hover:text-primary transition-colors text-on-surface"
        >
          arrow_back
        </Button>
      ...
      <div className="w-full max-w-4xl p-4 md:p-8 space-y-8 animate-fade-in pb-24">
        ...
        {/* Hero Image Section */}
        <div className="relative w-full h-64 md:h-96 glass-overlay rounded-2xl mechanical-border overflow-hidden group">
          <img 
          ...
          <div className="absolute bottom-4 left-4 md:bottom-8 md:left-8 z-10 flex flex-col">
            <span className="bg-primary/20 text-primary border border-primary font-label-caps font-bold px-3 py-1 rounded-md w-fit mb-2 backdrop-blur-sm">
              VIP UPGRADE
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="col-span-2 glass-overlay rounded-xl mechanical-border p-6 space-y-4">
          ...
          <div className="col-span-1 glass-overlay rounded-xl mechanical-border p-6 flex flex-col justify-center items-center text-center space-y-4 relative overflow-hidden">
        ...
        <div className="glass-overlay rounded-2xl mechanical-border p-8 flex flex-col items-center justify-center text-center mt-8 relative overflow-hidden group">
          <div className="absolute -top-10 -right-10 text-[120px] material-symbols-outlined text-primary/5 rotate-12 pointer-events-none transition-transform group-hover:scale-110">
            local_activity
          </div>
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl border border-outline-variant shadow-inner hover:scale-105 transition-transform duration-300">
            <div className="w-48 h-48 md:w-64 md:h-64 flex items-center justify-center bg-black rounded-lg">
              <span className="material-symbols-outlined text-white text-9xl font-light">qr_code_2</span>
            </div>
          </div>
